          ...
          <div className="grid gap-8 md:grid-cols-2">
            ...
            <Link href="/dashboard/about/about">
              <motion.div
                whileHover={{ scale: 1.03 }}
                whileTap={{ scale: 0.97 }}
                className="bg-gradient-to-br from-green-800 to-green-900 hover:shadow-xl text-white p-8 rounded-2xl flex flex-col justify-between h-full transition"
              >
                <div className="flex items-center gap-3 mb-4">
                  <FolderKanban size={28} />
                  <h3 className="text-2xl font-semibold">Manage About</h3>
                </div>
                <p className="opacity-90 mb-6">
                  View, update, and organize your portfolio about section.
                </p>
                <span className="text-sm font-medium opacity-80">
                  Go to About →
                </span>
